...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('email')->name('email.')->group(function () {
        ...
        Route::get('/accounts/{id}/edit', [EmailController::class, 'editAccount'])->name('email.accounts.edit');
        Route::put('/accounts/{id}', [EmailController::class, 'updateAccount'])->name('email.accounts.update');
