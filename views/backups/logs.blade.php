<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Backup Logs</h2>
    </x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold mb-4">Backup Operations Log</h3>
                    <div class="bg-gray-900 text-gray-100 p-4 rounded font-mono text-xs overflow-x-auto" style="max-height: 600px; overflow-y: scroll;">
                        @if (!empty($logs))
                            ...
                            @endforeach
                        @else
                            <div class="text-gray-500">No backup logs found.</div>
                        @endif
                    </div>
                </div>
            </div>
