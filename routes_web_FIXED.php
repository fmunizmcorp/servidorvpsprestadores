...
/*
|--------------------------------------------------------------------------
| Web Routes - Complete VPS Admin Panel with /admin prefix
|--------------------------------------------------------------------------
|
| CRITICAL FIX: All admin routes wrapped in /admin prefix to match NGINX config
| NGINX serves app at /admin/ path, so routes must match
|
*/
...
// Auth routes are loaded from auth.php and will be prefixed automatically
require __DIR__.'/auth.php';

// ==========================================
// ADMIN PANEL - All routes prefixed with /admin
// ==========================================
